...
export default function ThemeToggle({ compact = false }) {
  ...
  return (
    <button
      onClick={toggleTheme}
      aria-label={theme === "dark" ? "Switch to light mode" : "Switch to dark mode"}
      className="fixed top-4 right-4 z-50 flex h-9 w-9 items-center justify-center rounded-full border border-rv-border2 bg-rv-surface text-rv-muted shadow-sm transition hover:text-rv-accent hover:border-rv-accent/30"
    >
