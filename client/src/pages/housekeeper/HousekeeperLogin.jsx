...
export default function HousekeeperLogin() {
  ...
  const [email, setEmail] = useState("fatima.nasser@grandhotel.com");
  ...
  function handleSubmit(e) {
    ...
    setLoading(true);
    setTimeout(() => {
      localStorage.setItem("rv-role", "housekeeper");
      navigate("/housekeeper/tasks");
    }, 600);
  }
    ...
    <div className="flex min-h-screen items-center justify-center bg-rv-bg px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-3 text-2xl font-bold text-rv-text">Housekeeping login</h1>
          <p className="mt-1 text-sm text-rv-muted">housekeeping.reservio.com</p>
        </div>
